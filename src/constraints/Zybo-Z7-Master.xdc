...
##RGB LED 6
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {led6_red[0]}]
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { led6_green[0] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { led6_blue[0] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
...
set_property MARK_DEBUG false [get_nets {design_1_i/led6_red[0]}]
