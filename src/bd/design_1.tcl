...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins ps7_1_axi_periph/ACLK] [get_bd_pins ps7_1_axi_periph/M00_ACLK] [get_bd_pins ps7_1_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_1_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_1_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_1_axi_periph/ARESETN] [get_bd_pins ps7_1_axi_periph/M00_ARESETN] [get_bd_pins ps7_1_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_1_50M/peripheral_aresetn]
