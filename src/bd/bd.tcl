...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:axi_pwm_generator:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set led6_blue [ create_bd_port -dir O -from 0 -to 0 led6_blue ]
  set led6_green [ create_bd_port -dir O -from 0 -to 0 led6_green ]
  set led6_red [ create_bd_port -dir O -from 0 -to 0 led6_red ]
  ...
  # Create instance: btn_sw_gpio, and set properties
  set btn_sw_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 btn_sw_gpio ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins led_gpio/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports btns_4bits] [get_bd_intf_pins btn_sw_gpio/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports sws_4bits] [get_bd_intf_pins btn_sw_gpio/GPIO2]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins led_gpio/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins btn_sw_gpio/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net axi_pwm_generator_0_pwm_out [get_bd_ports led6_red] [get_bd_pins axi_pwm_generator_0/pwm_out]
  connect_bd_net -net axi_pwm_generator_1_pwm_out [get_bd_ports led6_green] [get_bd_pins axi_pwm_generator_1/pwm_out]
  connect_bd_net -net axi_pwm_generator_2_pwm_out [get_bd_ports led6_blue] [get_bd_pins axi_pwm_generator_2/pwm_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_pwm_generator_0/s00_axi_aclk] [get_bd_pins axi_pwm_generator_1/s00_axi_aclk] [get_bd_pins axi_pwm_generator_2/s00_axi_aclk] [get_bd_pins btn_sw_gpio/s_axi_aclk] [get_bd_pins led_gpio/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_pwm_generator_0/s00_axi_aresetn] [get_bd_pins axi_pwm_generator_1/s00_axi_aresetn] [get_bd_pins axi_pwm_generator_2/s00_axi_aresetn] [get_bd_pins btn_sw_gpio/s_axi_aresetn] [get_bd_pins led_gpio/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btn_sw_gpio/S_AXI/Reg] -force
